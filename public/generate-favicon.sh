...
convert -background transparent storefront-icon.svg -resize 16x16 temp_favicon/favicon-16x16.png
convert -background transparent storefront-icon.svg -resize 32x32 temp_favicon/favicon-32x32.png
convert -background transparent storefront-icon.svg -resize 48x48 temp_favicon/favicon-48x48.png
convert -background transparent storefront-icon.svg -resize 64x64 temp_favicon/favicon-64x64.png

# Combina em um único arquivo .ico
convert temp_favicon/favicon-16x16.png temp_favicon/favicon-32x32.png temp_favicon/favicon-48x48.png temp_favicon/favicon-64x64.png favicon.ico

# Limpa arquivos temporários
rm -rf temp_favicon

echo "Favicon gerado com sucesso em favicon.ico" 